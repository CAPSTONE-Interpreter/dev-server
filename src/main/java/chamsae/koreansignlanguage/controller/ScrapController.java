...
public class ScrapController {
    ...
    */
    ...
    public ResponseEntity<FindScrapsResDTO> getScrap(@ApiParam(value = "회원 ID", required = true) @PathVariable("mem_id") long mem_id) {
        log.info("GET /scraps/{} 실행 - 해당 회원 스크랩 리스트 불러오기 : {}", mem_id, mem_id);

        FindScrapsResDTO response = scrapService.findByMemId(mem_id);
